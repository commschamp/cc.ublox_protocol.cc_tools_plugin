...
class NavPvtPollImpl;
class NavPvtPoll : public cc_tools_qt_plugin::cc_ublox::Message
{
public:
    NavPvtPoll();
    ...
    virtual ~NavPvtPoll();
    NavPvtPoll& operator=(const NavPvtPoll& other);
    NavPvtPoll& operator=(NavPvtPoll&&);
    static MsgIdParamType doGetId();
    static constexpr bool hasStaticMsgId() { return true; }
    static constexpr MsgIdType staticMsgId() { return static_cast<MsgIdType>(263U); }
...
private:
    std::unique_ptr<NavPvtPollImpl> m_pImpl;
};
