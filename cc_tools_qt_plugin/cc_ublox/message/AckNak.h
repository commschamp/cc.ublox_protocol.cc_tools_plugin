...
class AckNakImpl;
class AckNak : public cc_tools_qt_plugin::cc_ublox::Message
{
public:
    AckNak();
    ...
    static constexpr MsgIdType staticMsgId() { return static_cast<MsgIdType>(1280U); }
...
private:
    std::unique_ptr<AckNakImpl> m_pImpl;
};
