...
class NavHpposecefImpl;
class NavHpposecef : public cc_tools_qt_plugin::cc_ublox::Message
{
public:
    NavHpposecef();
    ...
    NavHpposecef& operator=(const NavHpposecef& other);
...
private:
    std::unique_ptr<NavHpposecefImpl> m_pImpl;
};
