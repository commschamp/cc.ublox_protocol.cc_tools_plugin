...
class EsfInsImpl;
class EsfIns : public cc_tools_qt_plugin::cc_ublox::Message
{
public:
    EsfIns();
    ...
    virtual ~EsfIns();
    EsfIns& operator=(const EsfIns& other);
    EsfIns& operator=(EsfIns&&);
    static MsgIdParamType doGetId();
    static constexpr bool hasStaticMsgId() { return true; }
    static constexpr MsgIdType staticMsgId() { return static_cast<MsgIdType>(4117U); }
...
private:
    std::unique_ptr<EsfInsImpl> m_pImpl;
};
