...
class CfgRinvPollImpl;
class CfgRinvPoll : public cc_tools_qt_plugin::cc_ublox::Message
{
public:
    CfgRinvPoll();
    ...
    virtual ~CfgRinvPoll();
    CfgRinvPoll& operator=(const CfgRinvPoll& other);
    CfgRinvPoll& operator=(CfgRinvPoll&&);
    static MsgIdParamType doGetId();
    static constexpr bool hasStaticMsgId() { return true; }
    static constexpr MsgIdType staticMsgId() { return static_cast<MsgIdType>(1588U); }
...
private:
    std::unique_ptr<CfgRinvPollImpl> m_pImpl;
};
