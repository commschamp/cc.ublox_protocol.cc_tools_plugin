...
class CfgDgnssPollImpl;
class CfgDgnssPoll : public cc_tools_qt_plugin::cc_ublox::Message
{
public:
    CfgDgnssPoll();
    ...
    CfgDgnssPoll& operator=(const CfgDgnssPoll& other);
    CfgDgnssPoll& operator=(CfgDgnssPoll&&);
    static MsgIdParamType doGetId();
    static constexpr bool hasStaticMsgId() { return true; }
    static constexpr MsgIdType staticMsgId() { return static_cast<MsgIdType>(1648U); }
...
private:
    std::unique_ptr<CfgDgnssPollImpl> m_pImpl;
};
