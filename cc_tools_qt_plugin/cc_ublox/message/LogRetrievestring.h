...
class LogRetrievestringImpl;
class LogRetrievestring : public cc_tools_qt_plugin::cc_ublox::Message
{
public:
    LogRetrievestring();
    ...
    LogRetrievestring& operator=(const LogRetrievestring& other);
    ...
    static constexpr MsgIdType staticMsgId() { return static_cast<MsgIdType>(8461U); }
...
private:
    std::unique_ptr<LogRetrievestringImpl> m_pImpl;
};
