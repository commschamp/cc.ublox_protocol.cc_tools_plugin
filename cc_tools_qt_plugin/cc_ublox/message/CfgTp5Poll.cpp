...
class CfgTp5PollImpl : public
    cc_tools_qt::ProtocolMessageBase<
        ::cc_ublox::message::CfgTp5Poll<cc_tools_qt_plugin::cc_ublox::Message, cc_tools_qt_plugin::cc_ublox::options::DefaultOptions>,
        CfgTp5PollImpl
    >
{
public:
...
CfgTp5Poll::MsgIdParamType CfgTp5Poll::doGetId()
{
    return ::cc_ublox::message::CfgTp5Poll<cc_tools_qt_plugin::cc_ublox::Message, cc_tools_qt_plugin::cc_ublox::options::DefaultOptions>::doGetId();
}
...
void CfgTp5Poll::dispatchImpl(cc_tools_qt::MessageHandler& handler)
{
...
bool CfgTp5Poll::assignImpl(const cc_tools_qt::Message& other)
{
