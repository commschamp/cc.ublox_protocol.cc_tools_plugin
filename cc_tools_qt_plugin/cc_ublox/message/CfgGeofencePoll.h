...
class CfgGeofencePollImpl;
class CfgGeofencePoll : public cc_tools_qt_plugin::cc_ublox::Message
{
public:
    CfgGeofencePoll();
    ...
    CfgGeofencePoll& operator=(const CfgGeofencePoll& other);
    CfgGeofencePoll& operator=(CfgGeofencePoll&&);
    static MsgIdParamType doGetId();
    static constexpr bool hasStaticMsgId() { return true; }
    static constexpr MsgIdType staticMsgId() { return static_cast<MsgIdType>(1641U); }
...
private:
    std::unique_ptr<CfgGeofencePollImpl> m_pImpl;
};
