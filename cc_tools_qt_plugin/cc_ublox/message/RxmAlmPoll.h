...
class RxmAlmPollImpl;
class RxmAlmPoll : public cc_tools_qt_plugin::cc_ublox::Message
{
public:
    RxmAlmPoll();
    ...
    virtual ~RxmAlmPoll();
    RxmAlmPoll& operator=(const RxmAlmPoll& other);
    RxmAlmPoll& operator=(RxmAlmPoll&&);
    static MsgIdParamType doGetId();
    static constexpr bool hasStaticMsgId() { return true; }
    static constexpr MsgIdType staticMsgId() { return static_cast<MsgIdType>(560U); }
...
private:
    std::unique_ptr<RxmAlmPollImpl> m_pImpl;
};
