...
class InfErrorImpl;
class InfError : public cc_tools_qt_plugin::cc_ublox::Message
{
public:
    InfError();
    ...
    virtual ~InfError();
    InfError& operator=(const InfError& other);
    InfError& operator=(InfError&&);
    static MsgIdParamType doGetId();
    static constexpr bool hasStaticMsgId() { return true; }
    static constexpr MsgIdType staticMsgId() { return static_cast<MsgIdType>(1024U); }
...
private:
    std::unique_ptr<InfErrorImpl> m_pImpl;
};
