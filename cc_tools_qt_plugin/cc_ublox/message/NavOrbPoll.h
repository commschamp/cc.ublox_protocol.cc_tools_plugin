...
class NavOrbPollImpl;
class NavOrbPoll : public cc_tools_qt_plugin::cc_ublox::Message
{
public:
    NavOrbPoll();
    ...
    virtual ~NavOrbPoll();
    NavOrbPoll& operator=(const NavOrbPoll& other);
    NavOrbPoll& operator=(NavOrbPoll&&);
    static MsgIdParamType doGetId();
    static constexpr bool hasStaticMsgId() { return true; }
    static constexpr MsgIdType staticMsgId() { return static_cast<MsgIdType>(308U); }
...
private:
    std::unique_ptr<NavOrbPollImpl> m_pImpl;
};
