...
class MonHwPollImpl;
class MonHwPoll : public cc_tools_qt_plugin::cc_ublox::Message
{
public:
    MonHwPoll();
    ...
    virtual ~MonHwPoll();
    MonHwPoll& operator=(const MonHwPoll& other);
    MonHwPoll& operator=(MonHwPoll&&);
    static MsgIdParamType doGetId();
    static constexpr bool hasStaticMsgId() { return true; }
    static constexpr MsgIdType staticMsgId() { return static_cast<MsgIdType>(2569U); }
...
private:
    std::unique_ptr<MonHwPollImpl> m_pImpl;
};
