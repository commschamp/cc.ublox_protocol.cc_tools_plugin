...
class LogStringImpl;
class LogString : public cc_tools_qt_plugin::cc_ublox::Message
{
public:
    LogString();
    ...
    virtual ~LogString();
    LogString& operator=(const LogString& other);
    LogString& operator=(LogString&&);
    static MsgIdParamType doGetId();
    static constexpr bool hasStaticMsgId() { return true; }
    static constexpr MsgIdType staticMsgId() { return static_cast<MsgIdType>(8452U); }
...
private:
    std::unique_ptr<LogStringImpl> m_pImpl;
};
