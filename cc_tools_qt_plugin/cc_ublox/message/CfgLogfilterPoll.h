...
class CfgLogfilterPollImpl;
class CfgLogfilterPoll : public cc_tools_qt_plugin::cc_ublox::Message
{
public:
    CfgLogfilterPoll();
    ...
    CfgLogfilterPoll& operator=(const CfgLogfilterPoll& other);
    CfgLogfilterPoll& operator=(CfgLogfilterPoll&&);
    static MsgIdParamType doGetId();
    static constexpr bool hasStaticMsgId() { return true; }
    static constexpr MsgIdType staticMsgId() { return static_cast<MsgIdType>(1607U); }
...
private:
    std::unique_ptr<CfgLogfilterPollImpl> m_pImpl;
};
