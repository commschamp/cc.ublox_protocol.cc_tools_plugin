...
class AidHuiImpl;
class AidHui : public cc_tools_qt_plugin::cc_ublox::Message
{
public:
    AidHui();
    ...
    virtual ~AidHui();
    AidHui& operator=(const AidHui& other);
    AidHui& operator=(AidHui&&);
    static MsgIdParamType doGetId();
    static constexpr bool hasStaticMsgId() { return true; }
    static constexpr MsgIdType staticMsgId() { return static_cast<MsgIdType>(2818U); }
...
private:
    std::unique_ptr<AidHuiImpl> m_pImpl;
};
