...
class MonRfImpl;
class MonRf : public cc_tools_qt_plugin::cc_ublox::Message
{
public:
    MonRf();
    MonRf(const MonRf&) = delete;
    MonRf(MonRf&&) = delete;
    virtual ~MonRf();
    MonRf& operator=(const MonRf& other);
    MonRf& operator=(MonRf&&);
...
private:
    std::unique_ptr<MonRfImpl> m_pImpl;
};
