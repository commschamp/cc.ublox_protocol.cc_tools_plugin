...
class NavClockImpl;
class NavClock : public cc_tools_qt_plugin::cc_ublox::Message
{
public:
    NavClock();
    ...
    virtual ~NavClock();
    NavClock& operator=(const NavClock& other);
    NavClock& operator=(NavClock&&);
    static MsgIdParamType doGetId();
    static constexpr bool hasStaticMsgId() { return true; }
    static constexpr MsgIdType staticMsgId() { return static_cast<MsgIdType>(290U); }
...
private:
    std::unique_ptr<NavClockImpl> m_pImpl;
};
