...
class CfgMsgPollImpl;
class CfgMsgPoll : public cc_tools_qt_plugin::cc_ublox::Message
{
public:
    CfgMsgPoll();
    ...
    virtual ~CfgMsgPoll();
    CfgMsgPoll& operator=(const CfgMsgPoll& other);
...
private:
    std::unique_ptr<CfgMsgPollImpl> m_pImpl;
};
