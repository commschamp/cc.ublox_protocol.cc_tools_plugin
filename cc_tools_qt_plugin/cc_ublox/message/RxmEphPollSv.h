...
class RxmEphPollSvImpl;
class RxmEphPollSv : public cc_tools_qt_plugin::cc_ublox::Message
{
public:
    RxmEphPollSv();
    ...
    RxmEphPollSv& operator=(const RxmEphPollSv& other);
    RxmEphPollSv& operator=(RxmEphPollSv&&);
    static MsgIdParamType doGetId();
    static constexpr bool hasStaticMsgId() { return true; }
    static constexpr MsgIdType staticMsgId() { return static_cast<MsgIdType>(561U); }
...
private:
    std::unique_ptr<RxmEphPollSvImpl> m_pImpl;
};
