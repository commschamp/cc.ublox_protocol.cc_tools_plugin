...
class NavEoeImpl;
class NavEoe : public cc_tools_qt_plugin::cc_ublox::Message
{
public:
    NavEoe();
    ...
    static constexpr MsgIdType staticMsgId() { return static_cast<MsgIdType>(353U); }
...
private:
    std::unique_ptr<NavEoeImpl> m_pImpl;
};
