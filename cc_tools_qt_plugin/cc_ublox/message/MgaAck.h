...
class MgaAckImpl;
class MgaAck : public cc_tools_qt_plugin::cc_ublox::Message
{
public:
    MgaAck();
    ...
    virtual ~MgaAck();
    MgaAck& operator=(const MgaAck& other);
    MgaAck& operator=(MgaAck&&);
    static MsgIdParamType doGetId();
    static constexpr bool hasStaticMsgId() { return true; }
    static constexpr MsgIdType staticMsgId() { return static_cast<MsgIdType>(4960U); }
...
private:
    std::unique_ptr<MgaAckImpl> m_pImpl;
};
