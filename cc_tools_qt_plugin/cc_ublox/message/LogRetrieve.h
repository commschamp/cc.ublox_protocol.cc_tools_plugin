...
class LogRetrieveImpl;
class LogRetrieve : public cc_tools_qt_plugin::cc_ublox::Message
{
public:
    LogRetrieve();
    ...
    virtual ~LogRetrieve();
    LogRetrieve& operator=(const LogRetrieve& other);
    LogRetrieve& operator=(LogRetrieve&&);
    static MsgIdParamType doGetId();
    static constexpr bool hasStaticMsgId() { return true; }
    static constexpr MsgIdType staticMsgId() { return static_cast<MsgIdType>(8457U); }
...
private:
    std::unique_ptr<LogRetrieveImpl> m_pImpl;
};
