...
class RxmSfrbImpl;
class RxmSfrb : public cc_tools_qt_plugin::cc_ublox::Message
{
public:
    RxmSfrb();
    ...
    virtual ~RxmSfrb();
    RxmSfrb& operator=(const RxmSfrb& other);
    RxmSfrb& operator=(RxmSfrb&&);
    static MsgIdParamType doGetId();
    static constexpr bool hasStaticMsgId() { return true; }
    static constexpr MsgIdType staticMsgId() { return static_cast<MsgIdType>(529U); }
...
private:
    std::unique_ptr<RxmSfrbImpl> m_pImpl;
};
