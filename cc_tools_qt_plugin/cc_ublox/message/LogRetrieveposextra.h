...
class LogRetrieveposextraImpl;
class LogRetrieveposextra : public cc_tools_qt_plugin::cc_ublox::Message
{
public:
    LogRetrieveposextra();
    ...
    LogRetrieveposextra& operator=(const LogRetrieveposextra& other);
    ...
    static constexpr MsgIdType staticMsgId() { return static_cast<MsgIdType>(8463U); }
...
private:
    std::unique_ptr<LogRetrieveposextraImpl> m_pImpl;
};
