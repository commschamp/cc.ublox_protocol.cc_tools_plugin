...
class CfgPmImpl;
class CfgPm : public cc_tools_qt_plugin::cc_ublox::Message
{
public:
    CfgPm();
    ...
    CfgPm(CfgPm&&) = delete;
    virtual ~CfgPm();
    CfgPm& operator=(const CfgPm& other);
    CfgPm& operator=(CfgPm&&);
    static MsgIdParamType doGetId();
    static constexpr bool hasStaticMsgId() { return true; }
    static constexpr MsgIdType staticMsgId() { return static_cast<MsgIdType>(1586U); }
...
private:
    std::unique_ptr<CfgPmImpl> m_pImpl;
};
