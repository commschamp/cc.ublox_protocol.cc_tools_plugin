...
class MgaAnoImpl;
class MgaAno : public cc_tools_qt_plugin::cc_ublox::Message
{
public:
    MgaAno();
    ...
    virtual ~MgaAno();
    MgaAno& operator=(const MgaAno& other);
    MgaAno& operator=(MgaAno&&);
    static MsgIdParamType doGetId();
    static constexpr bool hasStaticMsgId() { return true; }
    static constexpr MsgIdType staticMsgId() { return static_cast<MsgIdType>(4896U); }
...
private:
    std::unique_ptr<MgaAnoImpl> m_pImpl;
};
