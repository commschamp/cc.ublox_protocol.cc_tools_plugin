...
class NavTimegloPollImpl : public
    cc_tools_qt::ProtocolMessageBase<
        ::cc_ublox::message::NavTimegloPoll<cc_tools_qt_plugin::cc_ublox::Message, cc_tools_qt_plugin::cc_ublox::options::DefaultOptions>,
        NavTimegloPollImpl
    >
{
public:
...
NavTimegloPoll::MsgIdParamType NavTimegloPoll::doGetId()
{
    return ::cc_ublox::message::NavTimegloPoll<cc_tools_qt_plugin::cc_ublox::Message, cc_tools_qt_plugin::cc_ublox::options::DefaultOptions>::doGetId();
}
...
void NavTimegloPoll::dispatchImpl(cc_tools_qt::MessageHandler& handler)
{
...
bool NavTimegloPoll::assignImpl(const cc_tools_qt::Message& other)
{
