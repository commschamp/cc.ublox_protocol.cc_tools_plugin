...
class NavHpposecefPollImpl;
class NavHpposecefPoll : public cc_tools_qt_plugin::cc_ublox::Message
{
public:
    NavHpposecefPoll();
    ...
    NavHpposecefPoll& operator=(const NavHpposecefPoll& other);
    NavHpposecefPoll& operator=(NavHpposecefPoll&&);
    static MsgIdParamType doGetId();
    static constexpr bool hasStaticMsgId() { return true; }
    static constexpr MsgIdType staticMsgId() { return static_cast<MsgIdType>(275U); }
...
private:
    std::unique_ptr<NavHpposecefPollImpl> m_pImpl;
};
