...
class NavTimegalImpl;
class NavTimegal : public cc_tools_qt_plugin::cc_ublox::Message
{
public:
    NavTimegal();
    ...
    virtual ~NavTimegal();
    NavTimegal& operator=(const NavTimegal& other);
    NavTimegal& operator=(NavTimegal&&);
    static MsgIdParamType doGetId();
    static constexpr bool hasStaticMsgId() { return true; }
    static constexpr MsgIdType staticMsgId() { return static_cast<MsgIdType>(293U); }
...
private:
    std::unique_ptr<NavTimegalImpl> m_pImpl;
};
