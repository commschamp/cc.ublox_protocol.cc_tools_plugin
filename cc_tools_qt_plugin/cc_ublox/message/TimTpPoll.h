...
class TimTpPollImpl;
class TimTpPoll : public cc_tools_qt_plugin::cc_ublox::Message
{
public:
    TimTpPoll();
    ...
    virtual ~TimTpPoll();
    TimTpPoll& operator=(const TimTpPoll& other);
    TimTpPoll& operator=(TimTpPoll&&);
    static MsgIdParamType doGetId();
    static constexpr bool hasStaticMsgId() { return true; }
    static constexpr MsgIdType staticMsgId() { return static_cast<MsgIdType>(3329U); }
...
private:
    std::unique_ptr<TimTpPollImpl> m_pImpl;
};
