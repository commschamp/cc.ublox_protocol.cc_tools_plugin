...
class InfWarningImpl;
class InfWarning : public cc_tools_qt_plugin::cc_ublox::Message
{
public:
    InfWarning();
    ...
    virtual ~InfWarning();
    InfWarning& operator=(const InfWarning& other);
    InfWarning& operator=(InfWarning&&);
    static MsgIdParamType doGetId();
    static constexpr bool hasStaticMsgId() { return true; }
    static constexpr MsgIdType staticMsgId() { return static_cast<MsgIdType>(1025U); }
...
private:
    std::unique_ptr<InfWarningImpl> m_pImpl;
};
