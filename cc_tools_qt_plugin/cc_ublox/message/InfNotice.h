...
class InfNoticeImpl;
class InfNotice : public cc_tools_qt_plugin::cc_ublox::Message
{
public:
    InfNotice();
    ...
    virtual ~InfNotice();
    InfNotice& operator=(const InfNotice& other);
    InfNotice& operator=(InfNotice&&);
    static MsgIdParamType doGetId();
    static constexpr bool hasStaticMsgId() { return true; }
    static constexpr MsgIdType staticMsgId() { return static_cast<MsgIdType>(1026U); }
...
private:
    std::unique_ptr<InfNoticeImpl> m_pImpl;
};
