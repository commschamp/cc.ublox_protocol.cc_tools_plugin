...
class NavPosllhPollImpl;
class NavPosllhPoll : public cc_tools_qt_plugin::cc_ublox::Message
{
public:
    NavPosllhPoll();
    ...
    NavPosllhPoll& operator=(const NavPosllhPoll& other);
    NavPosllhPoll& operator=(NavPosllhPoll&&);
    static MsgIdParamType doGetId();
    static constexpr bool hasStaticMsgId() { return true; }
    static constexpr MsgIdType staticMsgId() { return static_cast<MsgIdType>(258U); }
...
private:
    std::unique_ptr<NavPosllhPollImpl> m_pImpl;
};
