...
class MgaFlashAckImpl;
class MgaFlashAck : public cc_tools_qt::ToolsMessage
{
public:
    MgaFlashAck();
    ...
    virtual ~MgaFlashAck();
    MgaFlashAck& operator=(const MgaFlashAck& other);
...
private:
    using ImplPtr = std::unique_ptr<MgaFlashAckImpl>;

    MgaFlashAck(ImplPtr&& impl);
