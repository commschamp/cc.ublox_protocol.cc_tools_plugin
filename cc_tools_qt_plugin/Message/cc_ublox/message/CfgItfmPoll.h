...
class CfgItfmPollImpl;
class CfgItfmPoll : public cc_tools_qt::ToolsMessage
{
public:
    CfgItfmPoll();
    ...
    virtual ~CfgItfmPoll();
    CfgItfmPoll& operator=(const CfgItfmPoll& other);
...
private:
    using ImplPtr = std::unique_ptr<CfgItfmPollImpl>;

    CfgItfmPoll(ImplPtr&& impl);
