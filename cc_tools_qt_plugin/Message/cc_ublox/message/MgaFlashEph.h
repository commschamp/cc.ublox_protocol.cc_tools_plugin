...
class MgaFlashEphImpl;
class MgaFlashEph : public cc_tools_qt::ToolsMessage
{
public:
    MgaFlashEph();
    MgaFlashEph(const MgaFlashEph&) = delete;
    MgaFlashEph(MgaFlashEph&&) = delete;
    virtual ~MgaFlashEph();
    MgaFlashEph& operator=(const MgaFlashEph& other);
    MgaFlashEph& operator=(MgaFlashEph&&);
...
private:
    using ImplPtr = std::unique_ptr<MgaFlashEphImpl>;

    MgaFlashEph(ImplPtr&& impl);
