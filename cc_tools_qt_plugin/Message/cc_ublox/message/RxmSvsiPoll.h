...
class RxmSvsiPollImpl;
class RxmSvsiPoll : public cc_tools_qt::ToolsMessage
{
public:
    RxmSvsiPoll();
    ...
    virtual ~RxmSvsiPoll();
    RxmSvsiPoll& operator=(const RxmSvsiPoll& other);
...
private:
    using ImplPtr = std::unique_ptr<RxmSvsiPollImpl>;

    RxmSvsiPoll(ImplPtr&& impl);
